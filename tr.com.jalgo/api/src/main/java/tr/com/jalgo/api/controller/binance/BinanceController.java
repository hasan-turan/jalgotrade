...
import tr.com.jalgo.common.utils.JsonUtils;
...
public class BinanceController {
	...
	public BinanceController() {
		binance = new BinanceExchange(BinanceProperties.LIVE_API_KEY, BinanceProperties.LIVE_SECRET_KEY,
	...
	public ApiResponse help() throws ExchangeException {
		...
		return new ApiResponse(StatusType.OK, help.toString());
	}
	...
	public ApiResponse exchangeInfo() throws ExchangeException {
 
		return binance.getExchangeInfo(null);
	}
